...
exports.assignDataForGetAllGym = (req, res, next) => {
    ...
    const arr = ['gym', 'yoga', 'meditation'];
    if (arr.indexOf(req.params.type) === -1) {
    ...
    req.selectedData =
        'company profileImage address city hiwpmID fitness.price aboutus';
...
exports.getAllworkoutValues = catchAsync(async (req, res, next) => {
    ...
    req.body.docs = workoutVideos;
    return next();
});

// send json for workout videos
...
exports.assignDataForUpdatFitness = (req, res, next) => {
    ...
    req.body = {
        ...req.body,
        'fitness.aboutus': req.body.aboutus,
