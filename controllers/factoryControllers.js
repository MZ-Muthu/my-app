...
exports.findOne = (Model, errMsg) =>
    catchAsync(async (req, res, next) => {
        ...
        if (!docs) {
            return next(
                new AppError(
                    errMsg ?? 'Currently there are no services available.',
                    404
                )
            );
        }
...
exports.findOneAndUpdate = (Model) =>
    catchAsync(async (req, res, next) => {
        const UOdocs = await Model.findOneAndUpdate(
            req.updateOneSearch,
            req.body,
            {
                new: true,
...
exports.findOneAndUpdateWithOld = (Model) =>
    catchAsync(async (req, res, next) => {
        const UOdocs = await Model.findOneAndUpdate(
            req.updateOneSearch,
            req.body,
...
exports.findOneWithPopulate = (Model, errMsg) =>
    catchAsync(async (req, res, next) => {
        ...
        if (!findPopulateDocs) {
            return next(
                new AppError(
                    errMsg ?? 'Currently no datas available for this service',
                    400
                )
            );
        }
...
exports.deleteOne = (Model, errMsg) =>
    catchAsync(async (req, res, next) => {
