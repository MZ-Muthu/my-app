...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (req.query.mjwt || req.query.jwt || req.body.mjwt || req.body.jwt) {
        token =
            req.query.mjwt ?? req.body.mjwt ?? req.query.jwt ?? req.body.jwt;
        req.from = 'mobile';
    ...
    // token =
    //     'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzN2E2YTk2NmY0ZTcxZWRlMTE4NGVjOCIsImlhdCI6MTY2ODk2NzA2NywiZXhwIjoxNjc2NzQzMDY3fQ._7onRLttqfJbdXek8gFvviNfGgF7JpnhLnOpcy6yBi8';
    if (!token) {
        return next(
            new AppError(
