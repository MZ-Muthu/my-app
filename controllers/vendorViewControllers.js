...
exports.getVendorQuotes = (req, res) =>
    res.render('vendor/quotes/quotes', {
        activeScreen: 'quotes',
        partner: req.body.partner,
...
exports.vendorQuotesList = (req, res) =>
    res.status(200).render('vendor/quotes/lowestQuotesList', {
        activeScreen: 'quotes',
...
// manage medical market
exports.medicalMarketManageQuotes = (req, res) =>
    res
        .status(200)
        .render('vendor/medicalMarket/medicalMarketQuoteManagement', {
            partner: req.docs,
            requested: req.body.quotes.requested,
            negotiate: req.body.quotes.negotiate,
            history: req.body.quotes.history,
            activeScreen: 'myQuotes'
        });
// ============================================================
// ============================================================
// ============================================================
...
exports.getHospitalOrganAvailablity = (req, res) => {
    req.docs._id = undefined;
    res.status(200).render(
        'vendor/hospitals/organDonation/organDonationManagement',
        {
            partner: req.docs,
            activeScreen: 'organ',
            activeList: 'bus',
...
// ============================================================
// Fitness routes
exports.getFitenessHome = (req, res) =>
...
// pharmacy
// home
exports.pharmacyHome = (req, res) =>
    res.status(200).render('vendor/pharmacy/pharmacyHome', {
        partner: req.docs,
        activeScreen: 'home'
    });

// quotes
exports.pharmacyQuotesHome = (req, res) =>
    res.status(200).render('vendor/pharmacy/pharmacyQuotes', {
        partner: req.docs,
...
// quotes
exports.pharmacyProducts = (req, res) =>
    res.status(200).render('vendor/pharmacy/pharmacyProducts', {
        partner: req.docs,
