...
exports.verifyaddressandPartner = catchAsync(async (req, res, next) => {
    ...
    req.body.company = expert.partners.company;
    req.body.meetTheExpertId = expert._id;
...
exports.getAllMyExpertService = catchAsync(async (req, res, next) => {
    const [experts] = await bookExpertModel.aggregate([
        {
            $match: {
                userId: req.user._id
            }
