...
export let updateHospital = async (data) => {
    try {
        await axios({
            method: 'PATCH',
            ...
            .then((res) => {
                if (res.data.status === 'Success') {
                    swal(
                        'Success',
                        'Your Hospital profile updated successfully.',
                        'success'
                    );
...
// hospital nearby hospitals bus
export let createNewOrganAvailablity = async (data) => {
    try {
        await axios({
            method: 'POST',
            url: `/api/v1/hospital/organ/new-availablity`,
            data
        })
            .then((res) => {
                if (res.data.status === 'Success') {
                    swal(
                        'Success',
                        'You Organ availablity updated successfully.',
                        'success'
                    );
                    return setTimeout(() => location.reload(), 2000);
                }
...
// hospital nearby hospitals bus
export let updateOrganAvailablity = async (data, id) => {
    try {
        await axios({
            method: 'PATCH',
            url: `/api/v1/hospital/organ/update-availablity/${id}`,
            data
        })
            .then((res) => {
                if (res.data.status === 'Success') {
