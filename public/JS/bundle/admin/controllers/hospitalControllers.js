...
// hospital nearby hospitals bus
export let createNewOrganAvailablity = async (data, id) => {
    try {
        await axios({
            method: 'POST',
            url: `/api/v1/admin/vendor-management/hospital/organ/new-availablity/${id}`,
            data
        })
            .then((res) => {
                if (res.data.status === 'Success') {
...
// hospital nearby hospitals bus
export let updateOrganAvailablity = async (data, id, id2) => {
    try {
        await axios({
            method: 'PATCH',
            url: `/api/v1/admin/vendor-management/hospital/organ/update-availablity/${id}/${id2}`,
            data
        })
            .then((res) => {
                if (res.data.status === 'Success') {
