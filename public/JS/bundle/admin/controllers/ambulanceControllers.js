...
// manage ambulances
export let assignPrivateAmbulanceDriver = async (id, id1, id2, id3) => {
    try {
        await axios({
            method: 'PATCH',
            url: `/api/v1/admin/vendor-management/ambulance-services/assign-ambulance-driver/${id}/${id1}/${id2}/${id3}`
        })
            .then((res) => {
                if (res.data.status === 'Success') {
                    swal(
...
export let updateAmbulanceStatus = async (status, id, id2) => {
    try {
        swal({
            title: 'Are you sure?',
                ...
                if (willDelete) {
                    ...
                    await Swal.fire({
                        ...
                        .then(async (value) => {
                            await axios({
                                method: 'PATCH',
                                url: `/api/v1/admin/vendor-management/ambulance-services/update-quote-status/${status}/${id}/${id2}`,
                                data: value.value
                            })
                                .then((res) => {
                                    if (res.data.status === 'Success') {
...
export let updateUserAmbulanceStatus = async (status, id, id2) => {
    try {
        swal({
            title: 'Are you sure?',
            text: 'Are you want perform this action?',
                ...
                if (willDelete) {
                    await Swal.fire({
                        ...
                        .then(async (value) => {
                            await axios({
                                method: 'PATCH',
                                url: `/api/v1/admin/user-management/ambulance-services/update-quote-status/${status}/${id}/${id2}`,
                                data: value.value
                            })
                                .then((res) => {
                                    if (res.data.status === 'Success') {
...
// cancelQuoteUser
export let cancelQuoteUser = async (id, id2) => {
    try {
        swal({
            title: 'Are you sure?',
            text: 'Are you want perform this action?',
                ...
                if (willDelete) {
                    swal('Are you willing to enter your description?', {
                        ...
                        .then(async (data) => {
                            await axios({
                                method: 'PATCH',
                                url: `/api/v1/admin/user-management/ambulance-services/cancel-quote/${id}/${id2}`,
                                data
                            })
                                .then((res) => {
                                    if (res.data.status === 'Success') {
