...
const partnerSchema = new mongoose.Schema(
    {
        ...
        hospital: {
            ...
            organDonationVerificationDocument: {
                type: String
            }
        },
        hearingAid: {
        ...
        status: {
            ...
            default: 'pending',
            enum: ['pending', 'accepted', 'rejected', 'resubmited']
        },
        cause: {
            type: String
        },
...
partnerSchema.virtual('laboratorys', {
    ref: 'Laboratory Categories',
    foreignField: 'name',
    localField: 'laboratory.availableTests.name'
});
