...
const oneUsVideoCategoriesSchema = new mongoose.Schema({
    name: {
        type: String,
...
const oneUsVideoCategoriesModel = mongoose.model(
    'One Us Video Categories',
    oneUsVideoCategoriesSchema
);

// export mongoose schema
module.exports = oneUsVideoCategoriesModel;
