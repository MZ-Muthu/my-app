...
router.patch(
    ...
    laboratoryControllers.assignPartnerSearchForUpdateSerivce,
...
router.get(
    ...
    laboratoryControllers.sendJsonForDocs
);
...
router.patch(
    ...
    laboratoryControllers.uploadLabReportOfUser('image'),
    laboratoryControllers.checkFileAvailable,
    laboratoryControllers.assignPartnerSearch,
    laboratoryControllers.verifyValidPartner,
    laboratoryControllers.uploadLaboratoryReportToAWS,
