...
router.get(
    ...
    hospitalPackageControllers.sendJsonForDocs
);

// hosptial pacakge
router.get(
    '/package/get-package-details/:packageId/:categorieId/:subcategorie',
    hospitalPackageControllers.getHospialIndvidualPackageData
);
...
router.get(
    ...
    hospitalPackageControllers.assignForHospitalDetails,
...
router.patch(
    '/update-hospital',
    hospitalPackageControllers.uploadDocumentInOrganImage('docs'),
    hospitalPackageControllers.filterNewHospital,
    hospitalPackageControllers.uploadDocsInAWS,
    hospitalPackageControllers.assignPartnerSearchData,
    // hospitalPackageControllers.verifyValidPartner,
...
router.post(
    '/organ/new-availablity',
    // hospitalPackageControllers.setImageSizeForOrganAvailablity,
    fileUpload.uploadSingleImage('image'),
    hospitalPackageControllers.assignPartnerSearchForOrganAvailablity,
    hospitalPackageControllers.verifyValidPartner,
    hospitalPackageControllers.assignDataForCreateNewOrganAvailablity,
    hospitalPackageControllers.assignDataforGetAOrgan,
    hospitalPackageControllers.getAOrgan,
    hospitalPackageControllers.createNewOrganAvailablity,
    hospitalPackageControllers.sendServiceJson
);
// nearby hotsd
// update organ availablity
router.patch(
    '/organ/update-availablity/:organId',
    // hospitalPackageControllers.setImageSizeForOrganAvailablity,
    fileUpload.uploadSingleImage('image'),
    hospitalPackageControllers.assignDataforGetAOrgan,
    hospitalPackageControllers.getAOrgan,
    ...
    hospitalPackageControllers.verifyValidPartner,
    hospitalPackageControllers.assignDataForCreateNewOrganAvailablity,
    hospitalPackageControllers.assignDataforUpdateOrganAvailablity,
    hospitalPackageControllers.updateOrganAvailablity,
    hospitalPackageControllers.sendJsonForUpdateOne
);
...
router.get(
    '/organ/',
    hospitalPackageControllers.getAllOrgans,
    hospitalPackageControllers.sendJsonForOrgans
);

// get a organ
router.get(
    '/organ/organ-details/:organId',
    hospitalPackageControllers.getOrganDetails,
    hospitalPackageControllers.sendJsonForGetAOrgans
);
