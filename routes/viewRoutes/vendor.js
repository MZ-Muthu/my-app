...
router.get(
    ...
    vendorControllers.myVendorLists,
    vendorViewControllers.vendorHome
);
// blood donation home
router.get(
    '/blood-bank',
...
router.get(
    ...
    vendorViewControllers.getVendorQuotes
);
...
router.get(
    ...
    vendorViewControllers.vendorQuotesList
);
...
router.get(
    ...
    authControllers.protect,
    vendorControllers.getPartnerAndJobCategories,
    vendorViewControllers.postJob
);
...
router.get(
    ...
    authControllers.protect,
    vendorControllers.getJobPartnerAndJobCategories,
    vendorViewControllers.updateJob
);
...
router.get(
    '/medical-market/product-requests-management',
    authControllers.protect,
    medicalMarketControllers.getPartneranMarket,
    medicalMarketControllers.getMyQuotes,
    vendorViewControllers.medicalMarketManageQuotes
);
...
// organ management
router.get(
    '/hospital/organ-management',
    authControllers.protect,
    hospitalControllers.assignPartnerSearch,
    hospitalControllers.verifyValidPartner,
    hospitalControllers.assignDataForGetAvailablities,
    hospitalControllers.getAvailiablity,
    hospitalControllers.getAllOrgansLists,
    vendorViewControllers.getHospitalOrganAvailablity
);
...
router.get(
    ...
    vendorViewControllers.getFitenessHome
);
...
router.get(
    ...
    vendorViewControllers.pharmacyHome
);
// quotes management
router.get(
    '/pharmacy/quotes-management',
    authControllers.protect,
    pharmacyControllers.assignPartnerSearch,
    pharmacyControllers.verifyValidPartner,
    pharmacyControllers.getMyMedicineRequests,
    vendorViewControllers.pharmacyQuotesHome
);

// quotes management
router.get(
    '/pharmacy/my-medicines',
    authControllers.protect,
    pharmacyControllers.assignPartnerSearch,
    pharmacyControllers.verifyValidPartner,
    pharmacyControllers.getMyMedicines,
    vendorViewControllers.pharmacyProducts
);
