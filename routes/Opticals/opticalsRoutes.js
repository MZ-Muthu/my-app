...
router.post(
    ...
    opticalControllers.assignDataForUpdateOpticals,
    opticalControllers.verifyValidPartner,
    opticalControllers.verifyOpticalsProductData,
    opticalControllers.saveFilesAsJbgForOpticalProduct,
    opticalControllers.saveOpticalsProductToAWS,
...
// update hearing aid
router.patch(
    '/update-optical-product/:opticalId',
    authControllers.protect,
    opticalControllers.setImageSizeForOpticalProduct,
    // opticalControllers.verifyOpticalProductData,
    // opticalControllers.saveFilesAsJbg,
...
// generate optical images
router.post(
    '/get-images-for-opticals',
    authControllers.protect,
    opticalControllers.uploadSinglAndMultipleWithFrameImage,
    opticalControllers.getUploadImageFrameData
);
...
router.get(
    '/get-all-products',
    authControllers.protect,
    opticalControllers.getAllOpticalProducts,
    opticalControllers.sendAllFilter
);
...
router.get(
    ...
    opticalControllers.assignDataForGetAProduct,
    opticalControllers.getAOpticalProduct,
    opticalControllers.sendJsonForFindOneWithPopulate
);
// ============================================================
// export router
