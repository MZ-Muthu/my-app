...
router.patch(
    ...
    laboratoryVendorControllers.uploadLabReportOfUser('image'),
    laboratoryVendorControllers.checkFileAvailable,
    ...
    laboratoryVendorControllers.uploadLaboratoryReportToAWS,
