...
// hospital nearby facilitiees hospital iamges
router.patch(
    '/manage-nearby-hospital-facilities/:vendorId',
    adminControllers.assignDataForFindHospitalPackageDetail,
    adminControllers.getVendorADeatails,
    adminControllers.assignUserIdAndPartnerId,
...
router.post(
    '/organ/new-availablity/:vendorId',
    // hospitalVendorControllers.setImageSizeForOrganAvailablity,
    fileUpload.uploadSingleImage('image'),
    adminControllers.assignDataForFindHospitalPackageDetail,
    adminControllers.getVendorADeatails,
    adminControllers.assignUserIdAndPartnerId,
    hospitalVendorControllers.assignDataForCreateNewOrganAvailablity,
    hospitalVendorControllers.assignDataforGetAOrgan,
    hospitalVendorControllers.getAOrgan,
    hospitalVendorControllers.createNewOrganAvailablity,
    hospitalVendorControllers.sendServiceJson
);
// nearby hotsd
// update organ availablity
router.patch(
    '/organ/update-availablity/:vendorId/:organId',
    fileUpload.uploadSingleImage('image'),
    adminControllers.assignDataForFindHospitalOrgaDetail,
    adminControllers.getVendorADeatails,
    adminControllers.assignUserIdAndPartnerId,
    hospitalVendorControllers.assignDataForCreateNewOrganAvailablity,
    hospitalVendorControllers.assignDataforGetAOrgan,
    hospitalVendorControllers.getAOrgan,
    hospitalVendorControllers.assignDataforUpdateOrganAvailablity,
    hospitalVendorControllers.updateOrganAvailablity,
    hospitalVendorControllers.sendJsonForUpdateOne
);
